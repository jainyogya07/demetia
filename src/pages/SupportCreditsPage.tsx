  ...
  return (
    <div className="support-credits-page">
      <div className="support-credits-header">
        ...
        <button type="button" className="how-credits-button">
          <CircleHelp size={20} />
          How credits work
        </button>
      </div>
      ...
      <section className="credits-summary-card">
        <div className="credits-summary-left">
          ...
          <div className="credits-summary-text">
            ...
            <p className="credits-available-text">Support Credits available</p>
          </div>
        </div>
        ...
        <div className="credits-progress-section">
          ...
          <div className="credits-progress-bar">
            <div className="credits-progress-fill" />
          </div>
      ...
      <div className="credits-actions">
        <button type="button" className="topup-credits-button">
          <Plus size={23} />
          Top up Credits
        </button>
        ...
        {services.map((service) => {
          ...
          return (
            <button
              ...
              onClick={() => openModule(service.moduleId)}
            >
              ...
              <ArrowRight className="service-arrow" size={25} strokeWidth={1.7} />
            </button>
          );
        })}
      </div>
...
export default SupportCreditsPage;
