      ...
      <aside className={`sidebar${railCollapsed ? ' is-collapsed' : ''}`}>
        ...
        <div className="ss-gpt-scroll">
          ...
          <div className="sidebar-group-block">
            <div className="nav-group-title" style={{ marginTop: 16, marginBottom: 8, fontSize: 11, fontWeight: 700, color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase', letterSpacing: 1, paddingLeft: 12 }}>Safe Journey</div>
            <nav className="sidebar-nav">
              <NavLink 
      ...
      <main className="main-content">
        ...
        <header className="top-bar ss-topbar ss-transparent-header">
          ...
          <div className="top-bar-right ss-header-right">
            ...
            <button
              type="button"
              className="ss-notification-bell-btn"
