...
const ServicesCredits = () => {
  ...
  const [expandedService, setExpandedService] = useState<unknown>(null);
  const [focusedServiceId, setFocusedServiceId] = useState<unknown>(null);
  const catalogueRef = useRef<any>(null);
