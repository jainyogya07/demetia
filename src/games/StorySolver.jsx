...
export default function StorySolver() {
  ...
  const status = useMemo(() => {
    ...
    if (isSpeaking) return t({ en: 'Smriti is speaking', hi: 'स्मृति बोल रही हैं', as: 'স্মৃতি কৈ আছে' });
      ...
      <div className="game-area story-solver">
        <div className="story-hero">
          ...
          <p className="game-soft-lead">
            Story language is separate from the header. Listen uses the live companion voice.
          </p>
