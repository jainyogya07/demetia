...
export const DEMO_CITIES: DemoCity[] = [
  {
    ...
    viewerTitle: 'Simulated 360° walk · Assam',
    panoCaption: 'Assam · simulated street look',
  ...
  },
  {
    ...
    viewerTitle: 'Simulated 360° walk · Delhi',
    panoCaption: 'Delhi · simulated street look',
