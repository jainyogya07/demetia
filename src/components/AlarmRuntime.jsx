...
export default function AlarmRuntime() {
  ...
  /*
   * Setup Android native alarms.
   *
   * This runs when Smriti Saarthi starts.
   * The native alarms then remain scheduled
  ...
  /*
   * Browser foreground runtime.
   *
   * This keeps your existing in-app popup
   * working when the React application is open.
   */
  useEffect(() => {
    let cancelled = false;
