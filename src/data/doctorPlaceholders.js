...
export const DR_LIVE = {
  ...
  clock: '10:12 IST',
  lastSync: '2 min ago',
  feed: 'Courtyard ping · Latveria Devi · with Rina',
};
...
export const DR_PATIENTS = [
  {
    ...
    lastSeenPlace: 'Courtyard · story game with Rina',
    alerts: 1,
    mmse: 22,
    bp: '138/82',
    hr: 74,
    sugar: '142 mg/dL',
    caregiver: 'Rina Devi',
    caregiverRole: 'Daughter · primary',
    caregiverPhone: '94350-11820',
    caregiverPhotoUrl: daughterPhoto,
    appPath: '/user',
    comorbidities: ['Hypertension', 'Osteoarthritis', 'Vitamin D low'],
    cognitiveNote: 'Orientation to home preserved. Slower word-finding after lunch. Story-game engagement good in Assamese/Hindi.',
  },
  {
    id: 'binod',
    name: 'Binod Kalita',
    ...
    caregiverRole: 'Son',
    caregiverPhone: '98640-22118',
    caregiverPhotoUrl: '',
    appPath: '',
    comorbidities: ['Type 2 diabetes', 'Hearing loss'],
    cognitiveNote: 'Hearing aid trial discussed. Fasting sugar acceptable. Son will sit in next OPD.',
  },
  {
    id: 'moni',
    name: 'Moni Sangma',
    ...
    caregiverPhone: '94361-77801',
    caregiverPhotoUrl: '',
    appPath: '',
    comorbidities: ['Hypothyroid'],
    cognitiveNote: 'Two safety flags from family: evening wandering risk near the lane, missed Tele-MANAS ping. No med change — watch closely.',
  },
];
